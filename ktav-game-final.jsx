מדע,ניסוי,המצאה,טכנולוגיה,ביולוגיה,פיזיקה,כימיה,מתמטיקה,גיאוגרפיה,היסטוריה
מספר,חישוב,חיבור,חיסור,כפל,חילוק,שבר,אחוז,גרף,משוואה,נוסחה,צורה,זווית
עברית,אנגלית,ערבית,צרפתית,גרמנית,ספרדית,רוסית,שפה,מילה,משפט,אות,ניקוד
ירושלים,תל אביב,חיפה,באר שבע,נתניה,ראשון לציון,פתח תקווה,אשדוד,אשקלון
ים תיכון,ים המלח,כינרת,ירדן,גליל,נגב,שרון,עמק,הר,גבעה
נסיעה,טיול,חופשה,נופש,מלון,אכסניה,מחנה,סיור,מסלול,אתר,מוזיאון,גן לאומי,פארק
עולם,גלובוס,יבשת,אוקיאנוס,מדינה,עם,לאום,תרבות,דת,מסורת,פולקלור,אגדה,סיפור עם
ענן,סערה,שיטפון,רעידת אדמה,התפרצות,גל חום,בצורת,שריפה,הצפה,רוח
בריאות,חינוך,כלכלה,חברה,פוליטיקה,סביבה,אנרגיה,מים,מזון,דיור,תחבורה
`
  .split(/[,
]/)
  .map(w => w.trim())
  ...
  const approveWord = () => {
    ...
    if (newScore >= targetScore) {
      ...
      if (jokers.some(j => j.id === 'thrifty')) {
        reward += discardsLeft * 2; // +2₪ לכל זריקה שנשארה
      }
      if (jokers.some(j => j.id === 'efficient')) {
        reward += newHandsLeft * 3; // +3₪ לכל יד שנשארה
      }
      if (jokers.some(j => j.id === 'big_spender') && money === 0) {
        reward += 10; // +10₪ אם סיימנו בלי כסף
      }
      ...
      setTimeout(() => {
        setGameMode('shop');
        setRerollUsedThisShop(false); // איפוס רענון לסבב חדש
        generateShop();
      }, 1000);
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {jokers.length > 0 && (
            <div className="mb-8 bg-black/20 p-4 rounded-xl">
              <h2 className="text-xl font-bold mb-4 text-green-300">הג'וקרים שלי ({jokers.length}/{maxJokers})</h2>
              <div className="flex gap-4 flex-wrap">
                {jokers.map((joker) => (
                  <div key={joker.id} className="relative group">
                    ...
                    {/* כפתור מכירה */}
                    <button
                      onClick={() => sellJoker(joker)}
                      className="absolute -top-2 -right-2 bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center md:opacity-0 md:group-hover:opacity-100 transition-opacity hover:bg-red-700 font-bold z-20"
                      title={`מכור ב-${Math.floor(joker.cost / 2)}₪`}
                    >
                      💰
                    </button>
                    
                    {/* Tooltip עם פירוט - רק desktop */}
                    <div className="hidden md:block absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-black/95 text-white p-3 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-30 text-sm">
                      <div className="font-bold text-yellow-400 mb-1">{joker.icon} {joker.name}</div>
                      <div className="text-xs">{joker.desc}</div>
                      <div className="text-xs text-yellow-300 mt-2">💰 מכירה: {Math.floor(joker.cost / 2)}₪</div>
                      <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-black/95"></div>
                    </div>
                    
                    {/* פירוט למובייל - ב-click */}
                    <div className="md:hidden text-xs text-center mt-1 text-gray-300">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4 text-blue-300">ג'וקרים לקנייה ({jokers.length}/{maxJokers})</h2>
            <div className="flex gap-4 flex-wrap">
              {shopJokers.length > 0 ? shopJokers.map(joker => (
                <JokerCard
                  ...
                  canBuy={money >= joker.cost && jokers.length < maxJokers}
                />
              )) : (
          ...
          {shopVouchers.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-orange-300">🎁 בונוסים קבועים</h2>
              <div className="flex gap-4 flex-wrap">
                {shopVouchers.map(voucher => (
                  <div
                    key={voucher.id}
                    onClick={() => buyVoucher(voucher)}
                    className={`
                      p-6 bg-gradient-to-br from-orange-600 to-orange-800
                      rounded-xl border-4 border-orange-400 min-w-[200px] transition-all duration-200
                      ${money >= voucher.cost ? 'cursor-pointer hover:border-yellow-300 hover:scale-105 hover:shadow-2xl' : 'opacity-50 cursor-not-allowed'}
                    `}
                  >
                    <div className="text-4xl mb-2">{voucher.icon}</div>
                    <div className="font-bold text-lg mb-1">{voucher.name}</div>
                    <div className="text-sm text-white/90 mb-3">{voucher.desc}</div>
                    <div className="text-yellow-300 font-bold text-xl">{voucher.cost}₪</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {shopCards.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-cyan-300">🎴 קלפים חדשים</h2>
              <div className="flex gap-4 flex-wrap">
                {shopCards.map(card => (
                  <div
                    key={card.id}
                    ...
                    className={`
                      relative p-4 bg-gradient-to-br from-cyan-600 to-cyan-800
                      rounded-xl border-4 min-w-[160px] transition-all duration-200
                      ${money >= card.cost ? 'cursor-pointer hover:border-cyan-300 hover:scale-105 hover:shadow-2xl border-cyan-500' : 'opacity-50 cursor-not-allowed border-gray-600'}
                    `}
                  >
                    <div className="flex flex-col items-center">
                      {/* תצוגת הקלף */}
                      <div className="mb-3">
                        <Card card={card} inHand={false} />
                      </div>
                      
                      {/* תיאור */}
                      <div className="text-center">
                        {card.type === 'wildcard' && (
                          <div className="text-sm font-bold text-purple-200 mb-1">🌈 קלף כוכב!</div>
                        )}
                        {card.type === 'upgraded' && (
                          <div className="text-sm font-bold text-yellow-200 mb-1">✨ משודרג!</div>
                        )}
                        {card.type === 'normal' && (
                          <div className="text-sm text-cyan-200 mb-1">קלף רגיל</div>
                        )}
              ...
              <div className="text-xs text-gray-400 mt-2">
                💡 קלפים שנקנים מתוספים לחפיסה שלך לצמיתות
              </div>
            </div>
          )}
          ...
          <div className="flex gap-4">
            <button
              onClick={() => {
                ...
                if (money >= rerollCost) {
                  ...
                  if (canRerollFree) {
                    setRerollUsedThisShop(true);
                  }
                  generateShop();
                }
              }}
              className={`flex-1 px-6 py-4 rounded-xl font-bold text-xl transition-all transform hover:scale-105 shadow-xl ${
                money >= (hasFreeReroll && !rerollUsedThisShop ? 0 : 5)
            ...
            <button
              ...
              className="flex-1 px-8 py-4 bg-gradient-to-r from-green-600 to-green-800 rounded-xl font-bold text-xl hover:from-green-700 hover:to-green-900 transition-all transform hover:scale-105 shadow-xl"
            >
              ➡️ המשך למשחק
            </button>
          </div>
